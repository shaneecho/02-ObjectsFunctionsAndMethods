...
def try_methods():
    ...
    ###########################################################################
    todo_4 = rg.SimpleTurtle('turtle')
    todo_4.pen = rg.Pen('brown',5)
    todo_4.forward(150)
    todo_4.left(90)
    todo_4.forward(50)
    todo_4.backward(100)
...
def try_methods_and_functions():
    ...
    ###########################################################################
    todo_6 = rg.SimpleTurtle('turtle')
    todo_6.pen = rg.Pen('blue', 5)

    todo_6.backward(150)

    todo_6.speed = 1
    draw_many_squares(todo_6, 2, 100, 30)

    todo_6.speed = 5
    draw_many_squares(todo_6, 10, 50, 15)

    todo_6.speed = 100
    todo_6.pen = rg.Pen('blue', 35)
    draw_many_squares(todo_6, 8, 300, 60)

    todo_6.pen = rg.Pen('black', 3)

    todo_6.backward(200)

    todo_6.draw_circle(30)

    todo_6.draw_square(50)
