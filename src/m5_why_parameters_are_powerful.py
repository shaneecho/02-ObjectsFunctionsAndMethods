...
def main():
    ...
    even_better_draw_circles(rg.Point(100, 50), 5, 20, 'green', 2)
    even_better_draw_circles(rg.Point(-200, 0), 8, 25, 'blue', 3)
...
def even_better_draw_circles(point, radii, num, color, thickness):
